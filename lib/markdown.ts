...
function sanitizePublicLine(text: string): string {
  return text
    ...
    .replace(/\bFor Brett, this validates\b/gi, 'This validates')
    .replace(/exactly the governance conversation Brett needs to own/gi, 'exactly the governance conversation institutions need to own')
    .replace(/\bfor Brett's /gi, 'for the ')
    .replace(/\bBrett uses at UC San Diego\b/gi, 'the UC San Diego deployment uses')
    .replace(/\bBrett faces at scale with TritonGPT\b/gi, 'the platform faces at scale')
    .replace(/\bBrett's governance-first approach\b/gi, 'a governance-first approach')
    ...
    .replace(/\byour exact stack\b/gi, 'the exact stack')
    ...
    .replace(/\byour upcoming cabinet and conference presentations\b/gi, 'upcoming governance and public presentations')
