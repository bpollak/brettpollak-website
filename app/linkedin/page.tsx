  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-green-900 via-green-700 to-emerald-600 bg-clip-text text-transparent mb-8 tracking-tight">LinkedIn</h1>
        ...
        <div className="border-t border-gray-200 pt-12 text-center">
          <a
            ...
            className="inline-flex items-center gap-3 bg-gradient-to-r from-green-800 to-green-600 text-white px-10 py-4 font-bold rounded-lg hover:from-green-900 hover:to-green-700 transition-all duration-300 shadow-lg hover:shadow-xl group focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-700"
          >
