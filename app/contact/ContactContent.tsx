    ...
    <main className="page-shell" id="main-content" tabIndex={-1}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div className="editorial-panel p-8 md:p-10 border-l-4 border-l-[#1f5a8a] flex flex-col card-3d">
              ...
              <div className="mb-8">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <svg aria-hidden="true" className="w-5 h-5 text-signal-blue flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-body">AI implementation in higher education</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg aria-hidden="true" className="w-5 h-5 text-signal-blue flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-body">Data governance, privacy, and security</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg aria-hidden="true" className="w-5 h-5 text-signal-blue flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-body">Institutional knowledge, workflows, and support models</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg aria-hidden="true" className="w-5 h-5 text-signal-blue flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-body">Adoption, training, and organizational change</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="border-t border-line pt-8">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <svg aria-hidden="true" className="w-5 h-5 text-signal-gold-ink flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-body">Cross-institution collaboration or shared learning</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg aria-hidden="true" className="w-5 h-5 text-signal-gold-ink flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-body">Research, writing, or panels with a learning focus</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg aria-hidden="true" className="w-5 h-5 text-signal-gold-ink flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-body">Practical challenges from campus pilots or production systems</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg aria-hidden="true" className="w-5 h-5 text-signal-gold-ink flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-body">What has and hasn&apos;t worked at your institution</span>
                  </li>
                </ul>
              </div>
        ...
        <div className="editorial-panel editorial-dark p-8 md:p-12">
          ...
          <p className="text-2xl font-semibold mb-3 text-signal-gold-lift">
