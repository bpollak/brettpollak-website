        ...
        <div className="mb-16">
          <div className="grid lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div className="editorial-panel p-8 md:p-10 border-l-4 border-l-[#1f5a8a] flex flex-col card-3d">
              <h2 className="text-3xl font-bold text-slate-900 mb-6">What I&apos;d Love to Talk About</h2>

              <div className="mb-8">
                <h3 className="text-xl font-bold text-blue-800 mb-4">Topics I Keep Returning To</h3>
                <p className="text-slate-600 mb-4 leading-relaxed">
                  Some conversations I especially value:
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <svg aria-hidden="true" className="w-5 h-5 text-blue-700 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="border-t border-slate-200 pt-8">
                <h3 className="text-xl font-bold text-amber-600 mb-4">Helpful Context When You Reach Out</h3>
                <p className="text-slate-600 mb-4 leading-relaxed">
                  It&apos;s helpful to know a bit about what your institution is working through, especially around:
                </p>
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <svg aria-hidden="true" className="w-5 h-5 text-amber-600 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
