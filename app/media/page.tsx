    ...
    <div className="min-h-screen bg-gray-50" id="main-content">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="relative">
          ...
          <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-green-800 via-green-600 to-emerald-500 transform md:-translate-x-1/2 hidden sm:block"></div>
              ...
              <div key={year} className="mb-16 relative">
                ...
                <div className="flex items-center justify-center mb-12">
                  <div className="relative z-10">
                    <div className="absolute -inset-4 bg-gradient-to-r from-green-800 to-emerald-600 rounded-full opacity-20 blur-xl"></div>
                    <div className="relative bg-gradient-to-r from-green-800 to-emerald-600 text-white px-8 py-4 rounded-full shadow-xl">
