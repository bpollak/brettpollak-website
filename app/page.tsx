      ...
      <section className="relative max-w-7xl mx-auto px-6 pt-24 pb-32">
        ...
        <div className="grid md:grid-cols-12 gap-16 items-center">
          ...
          <div className="md:col-span-5 relative animate-slide-in-right">
            <div className="hidden md:block absolute -inset-8 bg-gradient-to-br from-blue-300 via-indigo-300 to-purple-300 rounded-3xl transform rotate-6 opacity-20 blur-2xl"></div>
      ...
      <section className="bg-gradient-to-b from-white to-gray-50 py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mt-12">
            ...
            <Link
              href="/media"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-3 rounded-xl font-bold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 group focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-600"
            >
