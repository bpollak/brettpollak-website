  ...
  return (
    <div className="min-h-screen bg-gray-50" id="main-content">
      ...
      <section className="relative max-w-7xl mx-auto px-6 pt-24 pb-32">
        <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-green-100 to-emerald-100 rounded-full blur-3xl opacity-20 -z-10 animate-pulse-glow"></div>
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-teal-100 to-lime-100 rounded-full blur-3xl opacity-15 -z-10 animate-float-slow"></div>
        <div className="grid md:grid-cols-12 gap-16 items-center">
          <div className="md:col-span-7 md:pr-8 animate-slide-in-left">
            <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-green-50 via-emerald-50 to-teal-50 border-2 border-green-200/60 text-green-800 text-sm font-bold rounded-full mb-10 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="w-24 h-1.5 bg-gradient-to-r from-green-900 via-green-700 to-emerald-500 rounded-full mb-10"></div>
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-3 bg-gradient-to-r from-green-800 to-green-600 text-white px-12 py-5 text-lg font-bold rounded-xl hover:from-green-900 hover:to-green-700 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-0.5 group focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-700"
            >
              Get in Touch
          ...
          <div className="md:col-span-5 relative animate-slide-in-right">
            <div className="hidden md:block absolute -inset-8 bg-gradient-to-br from-green-300 via-emerald-300 to-teal-300 rounded-3xl transform rotate-6 opacity-20 blur-2xl"></div>
            <div className="hidden md:block absolute -inset-6 bg-gradient-to-br from-green-200 via-emerald-200 to-teal-200 rounded-3xl transform rotate-3 opacity-40 blur-xl"></div>
            <div className="hidden md:block absolute -inset-4 bg-gradient-to-br from-green-100 to-emerald-100 rounded-2xl transform rotate-2 shadow-2xl"></div>
            <div className="hidden md:block absolute -inset-3 bg-gradient-to-tr from-teal-100 to-lime-100 rounded-2xl transform -rotate-1 opacity-70"></div>
      ...
      <section className="bg-gradient-to-b from-white to-gray-50 py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-green-800 via-green-600 to-emerald-500 bg-clip-text text-transparent mb-6 tracking-tight">As Featured In</h2>
          ...
          <div className="text-center mt-12">
            ...
            <Link
              href="/media"
              className="inline-flex items-center gap-2 bg-gradient-to-r from-green-800 to-green-600 text-white px-8 py-3 rounded-xl font-bold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 group focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-700"
            >
      ...
      <section className="bg-gradient-to-br from-gray-900 to-gray-800 py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16 text-center">
            <div className="inline-block px-4 py-1.5 bg-green-600/20 text-green-300 text-sm font-semibold rounded-full mb-6">
              REAL IMPACT
            </div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-green-300 via-emerald-300 to-teal-300 bg-clip-text text-transparent mb-6 tracking-tight px-4 max-w-5xl mx-auto">Transforming Higher Education</h2>
            <div className="w-20 h-1.5 bg-green-600 mx-auto"></div>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10 hover:border-green-500/50 hover:bg-white/10 transition-all duration-300 group card-3d animate-slide-up delay-100">
              <div className="w-12 h-12 bg-gradient-to-br from-green-800 to-green-600 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-green-400 transition-colors">Democratizing Knowledge</h3>
              ...
              <div className="text-green-400 font-semibold">73K+ active users</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10 hover:border-emerald-500/50 hover:bg-white/10 transition-all duration-300 group card-3d animate-slide-up delay-200">
              <div className="w-12 h-12 bg-gradient-to-br from-emerald-700 to-emerald-500 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-emerald-400 transition-colors">Accelerating Efficiency</h3>
              <p className="text-gray-300 leading-relaxed mb-4">
              ...
              <div className="text-emerald-400 font-semibold">91% time reduction</div>
            </div>
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10 hover:border-teal-500/50 hover:bg-white/10 transition-all duration-300 group card-3d animate-slide-up delay-300">
              <div className="w-12 h-12 bg-gradient-to-br from-teal-700 to-teal-500 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
              </div>
              <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-teal-400 transition-colors">Leading at Scale</h3>
              <p className="text-gray-300 leading-relaxed mb-4">
              ...
              <div className="text-teal-400 font-semibold">80+ team members</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-32">
        <div className="mb-20 text-center">
          ...
          <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-green-900 via-green-700 to-emerald-600 bg-clip-text text-transparent mb-6 tracking-tight">Areas of Focus</h2>
          <div className="w-20 h-1.5 bg-gradient-to-r from-green-900 via-green-700 to-emerald-600 mx-auto"></div>
        </div>
        <div className="grid md:grid-cols-2 gap-12">
          <div className="group p-8 border-l-4 border-green-800 bg-gradient-to-br from-green-50/40 to-emerald-50/40 hover:from-green-50 hover:to-emerald-50 transition-all duration-300 rounded-xl animate-slide-up delay-100">
            <h3 className="text-2xl font-bold bg-gradient-to-r from-green-800 to-emerald-700 bg-clip-text text-transparent mb-4">AI in Higher Education</h3>
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white pt-16 pb-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-20 text-center">
            <div className="inline-block px-4 py-1.5 bg-emerald-50 text-emerald-800 text-sm font-semibold rounded-full mb-6">
              EXPLORE
            </div>
            <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-emerald-700 via-teal-700 to-green-700 bg-clip-text text-transparent mb-6 tracking-tight">Learn More</h2>
            <div className="w-20 h-1.5 bg-gradient-to-r from-emerald-700 via-teal-700 to-green-700 mx-auto"></div>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/about" className="group relative bg-white/90 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 card-3d animate-slide-up delay-100">
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-green-800 to-emerald-600"></div>
              <div className="p-10">
                <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center mb-6 group-hover:bg-gradient-to-br group-hover:from-green-800 group-hover:to-emerald-600 transition-all">
                  <svg className="w-6 h-6 text-green-800 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex items-center text-green-800 font-semibold group-hover:gap-2 transition-all">
                  Read more
      ...
      {/* Contact CTA */}
      <section className="relative bg-gradient-to-br from-green-900 via-green-700 to-emerald-600 py-24 overflow-hidden animate-gradient-shift">
        <div className="absolute inset-0 bg-grid-pattern opacity-10"></div>
        <div className="absolute top-0 right-0 w-96 h-96 bg-lime-400 rounded-full blur-3xl opacity-20 animate-float-slow"></div>
        <div className="max-w-4xl mx-auto px-6 text-center relative">
          <h2 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-green-200 via-emerald-200 to-teal-200 bg-clip-text text-transparent mb-8 tracking-tight">Let&apos;s Connect</h2>
