...
export default function Home() {
  const personSchema = {
    ...
    "description": "Technology Executive at UC San Diego specializing in Artificial Intelligence, Data, and Digital Transformation. Creator of TritonGPT serving 87,000+ users.",
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10 hover:border-cyan-500/50 hover:bg-white/10 transition-all duration-300 group card-3d animate-slide-up delay-100">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                TritonGPT serves 87,000+ users across UC San Diego, making institutional knowledge accessible to students, faculty, and staff in seconds instead of hours.
              </p>
              <div className="text-cyan-400 font-semibold">87K+ active users</div>
            </div>
