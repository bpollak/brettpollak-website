...
export default function TritonGPTContent() {
  ...
  const programOfferingStyles = [
    {
      card: "",
      iconWrap: "bg-paper-2 border-2 border-ink text-ink group-hover:bg-accent",
      cta: "text-ink group-hover:text-accent",
    },
    {
      card: "",
      iconWrap: "bg-paper-2 border-2 border-ink text-ink group-hover:bg-accent",
    ...
    <div className="min-h-screen bg-paper" id="main-content">
      ...
      <section className="relative section-dark overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24">
          <div className="animate-slide-in-left eyebrow eyebrow--accent text-paper mb-6">
            PROGRAM OVERVIEW
          </div>
          <h1 className="animate-slide-up display-title display-title--xl text-paper mb-6">
            TritonAI
          </h1>
          <div className="divider-accent w-32 mb-8"></div>
          <p className="animate-slide-up delay-100 text-2xl md:text-3xl text-paper mb-6 leading-tight font-semibold">
            A shared AI ecosystem for service, instruction, and everyday campus work
          </p>
          <p className="animate-slide-up delay-150 max-w-4xl text-lg md:text-xl text-paper/70 mb-8 leading-relaxed">
          ...
          <div className="animate-fade-in delay-200 flex flex-wrap gap-4">
            <div className="flex items-center gap-2 border-2 border-paper px-3 py-1 text-xs uppercase tracking-wide font-[family-name:var(--font-geist-mono)] text-paper">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        <div className="card-hard p-10 border-l-4 border-accent relative overflow-hidden group">
          <h2 className="display-title display-title--lg text-ink mb-6">Executive Summary</h2>
          <p className="text-xl text-muted leading-relaxed relative z-10 mb-8">
            <span className="font-bold text-ink">TritonAI</span> is UC San Diego&apos;s approach to making AI useful across the university. It brings together secure infrastructure, task-specific assistants, embedded experiences, developer access, and shared tools into one campus ecosystem.
          </p>
          <p className="text-xl text-muted leading-relaxed relative z-10 mb-8">
            <span className="font-bold text-ink">TritonGPT</span> is the platform layer at the center of that work: a secure, SDSC-hosted environment that supports more than <span className="font-bold text-ink">73,000 students, staff, and faculty</span> without per-token costs. From that foundation, TritonAI is expanding into instructional tools, public-facing support, model access for developers, and the building blocks for agentic workflows.
          </p>
          <a
            href="https://ucsd-presentation.vercel.app/#slide=1"
            target="_blank"
            rel="noopener noreferrer"
            className="relative z-10 btn-bold px-8 py-4 uppercase tracking-wide group/link"
          >
      ...
      <section className="max-w-6xl mx-auto px-6 pb-16">
        <div className="text-center mb-10">
          <h2 className="display-title display-title--lg text-ink mb-3">What TritonAI Includes</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            return (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={`card-hard p-7 group ${style.card}`}
              >
                <div className="flex items-start gap-4">
                  <div className={`w-10 h-10 flex items-center justify-center flex-shrink-0 transition-colors ${style.iconWrap}`}>
                    {offering.icon}
                  </div>
                  <div>
                    <h3 className="text-lg font-bold text-ink">{offering.title}</h3>
                    <p className="mt-2 text-sm text-muted leading-relaxed">{offering.description}</p>
                    <p className={`mt-4 text-sm font-bold uppercase tracking-wide inline-flex items-center gap-2 transition-colors ${style.cta}`}>
                      Learn more
      ...
      {/* Key Metrics */}
      <section className="bg-paper-2 border-t-2 border-ink py-20" ref={metricsRef}>
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="display-title display-title--lg text-ink mb-4">Early Signals from TritonAI</h2>
            ...
            <div className="divider-accent w-24 mx-auto"></div>
          </div>
          <div className="grid md:grid-cols-4 gap-8">
            <div className="card-hard text-center p-8 group relative overflow-hidden">
              <div className="relative z-10">
                <div className="stat-number mb-2">
                  <AnimatedNumber end={91} isVisible={metricsVisible} />%
                </div>
                <div className="stat-label text-ink">Faster Contract Review</div>
                <div className="text-sm text-muted mt-2">120 minutes to 11 minutes on average</div>
              </div>
            </div>
            <div className="card-hard text-center p-8 group relative overflow-hidden delay-100">
              <div className="relative z-10">
                <div className="stat-number mb-2">
                  <AnimatedNumber end={83} isVisible={metricsVisible} />%
                </div>
                <div className="stat-label text-ink">Faster Job Description Drafting</div>
                <div className="text-sm text-muted mt-2">30 minutes to 5 minutes on average</div>
              </div>
            </div>
            <div className="card-hard text-center p-8 group relative overflow-hidden delay-200">
              <div className="relative z-10">
                <div className="stat-number mb-2">
                  $<AnimatedNumber end={500} isVisible={metricsVisible} />K
                </div>
                <div className="stat-label text-ink">Projected Annual Savings</div>
                <div className="text-sm text-muted mt-2">From replacing third-party public support tooling</div>
              </div>
            </div>
            <div className="card-hard text-center p-8 group relative overflow-hidden delay-300">
              <div className="relative z-10">
                <div className="stat-number mb-2">
                  <AnimatedNumber end={81} isVisible={metricsVisible} />%
                </div>
                <div className="stat-label text-ink">Student Learning Impact</div>
                <div className="text-sm text-muted mt-2">Reported the tutor helped them understand concepts</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        <h2 className="display-title display-title--lg text-ink mb-4">How TritonAI Is Taking Shape</h2>
        <div className="divider-accent w-24 mb-8"></div>
        <p className="text-lg text-muted max-w-4xl mb-10">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {[
            ...
            <div key={principle.title} className="card-hard p-8">
      ...
      <section className="bg-paper py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="display-title display-title--lg text-ink mb-4">TritonAI in Action</h2>
            <p className="text-xl text-muted">Examples from the TritonAI portfolio, built on TritonGPT and connected to everyday university work.</p>
          </div>
      ...
      {/* Use Cases */}
      <section className="bg-paper-2 border-t-2 border-ink py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-4xl mb-12">
            <h2 className="display-title display-title--lg text-ink mb-4">Examples Across the TritonAI Portfolio</h2>
            <p className="text-lg text-muted">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {[
              ...
              return (
                <div
                  key={index}
                  className="card-hard p-8 group flex flex-col"
                >
                  <div className="w-12 h-12 bg-paper-2 border-2 border-ink flex items-center justify-center mb-6 transition-colors group-hover:bg-accent">
                    <div className="text-ink transition-colors">
                      {assistant.icon}
                    </div>
                  </div>
                  <h4 className="text-xl font-bold text-ink mb-3 transition-colors group-hover:text-accent">
                    {assistant.name}
                  </h4>
                  ...
                  {assistant.metric && (
                    <div className="mt-auto">
                      <p className="text-sm font-semibold mb-1 text-accent">{assistant.metric}</p>
                      {assistant.stats && <p className="text-xs text-muted">{assistant.stats}</p>}
                    </div>
                  )}
      ...
      <section className="relative bg-paper py-24 overflow-hidden">
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          <h2 className="display-title display-title--lg text-ink mb-12 text-center">Recognition & Awards</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <a
              href="https://www.cio.com/article/4032770/unpacking-uc-san-diegos-use-of-llms-to-boost-access-to-knowledge.html"
              target="_blank"
              rel="noopener noreferrer"
              className="card-hard p-8 group block"
            >
              <div className="w-16 h-16 bg-paper-2 border-2 border-ink flex items-center justify-center mx-auto mb-6 group-hover:bg-accent transition-colors">
              ...
              <h3 className="text-2xl font-bold text-ink mb-2 text-center group-hover:text-accent transition-colors">CIO 100 Award</h3>
              <p className="text-muted text-center">2025 - Recognized as top global IT innovation</p>
            </a>
            <a
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-ink mb-2 text-center group-hover:text-accent transition-colors">Gartner Eye on Innovation</h3>
              <p className="text-muted text-center">Finalist for transformational impact in education</p>
            </a>
          </div>
        </div>
      </section>
      ...
      {/* Future Roadmap */}
      <section className="max-w-5xl mx-auto px-6 py-20">
        <h2 className="display-title display-title--lg text-ink mb-4">Where TritonAI Is Going Next</h2>
        <p className="text-lg text-muted max-w-4xl mb-12">
      ...
      {/* Conclusion */}
      <section className="relative section-dark py-20 overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h2 className="display-title display-title--lg text-paper mb-8 animate-fade-in">What We&apos;re Learning Through TritonAI</h2>
          <p className="text-2xl text-paper/70 leading-relaxed mb-8 animate-slide-up">
          ...
          <div className="inline-block px-6 py-3 bg-ink-2 border-2 border-accent transition-all duration-300">
            <p className="text-paper italic">TritonAI is one way of learning how shared institutional AI can become practical, trusted, and reusable.</p>
          </div>
        </div>
      </section>

      {/* Contact CTA */}
      <section className="bg-paper-2 border-t-2 border-ink py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="display-title display-title--lg text-ink mb-6">Want to Compare Notes?</h2>
