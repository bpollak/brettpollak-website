    ...
    <div className="min-h-screen bg-gray-50" id="main-content">
            ...
            <div className="card-3d text-center p-8 bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 group relative overflow-hidden delay-200">
              ...
              <div className="relative z-10">
                <div className="text-5xl font-bold text-cyan-600 mb-2 transition-all duration-300 group-hover:scale-110">
                  <AnimatedNumber end={73} suffix="K+" />
                </div>
      ...
      <section className="bg-gray-50 py-20">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="card-3d bg-white p-10 rounded-2xl shadow-xl border-t-4 border-teal-500 hover:shadow-2xl transition-all">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="bg-teal-50 border border-teal-100 p-6 rounded-xl">
                  ...
                  <p className="text-teal-800 text-sm">TritonGPT technology is already being utilized by multiple leading universities across the country, establishing a new standard for shared innovation in the public sector.</p>
                </div>
              </div>
                            ...
                            <div className="max-w-5xl mx-auto px-6 relative z-10">
                              ...
                              <div className="grid md:grid-cols-2 gap-8">
                                ...
                                <div className="card-3d bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 group">
                                  ...
                                  <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500">
                                  ...
                                  <h3 className="text-2xl font-bold text-gray-900 mb-2 text-center group-hover:text-blue-600 transition-colors">CIO 100 Award</h3>
                                ...
                                <div className="card-3d bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 group">
                                  ...
                                  <div className="w-16 h-16 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 group-hover:rotate-12 transition-all duration-500">
                                  ...
                                  <h3 className="text-2xl font-bold text-gray-900 mb-2 text-center group-hover:text-indigo-600 transition-colors">Gartner Eye on Innovation</h3>
