        ...
        <div className="mb-20 editorial-panel p-8 md:p-12">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 border-l-4 border-l-indigo-600 shadow-sm hover:shadow-md transition-shadow card-3d">
              ...
              <p className="text-lg text-slate-600 leading-relaxed">The TritonAI platform has been adopted by peer institutions including BearGPT at UC Berkeley, UC Agriculture and Natural Resources, and Fairleigh Dickinson University — with additional campuses exploring the deployment model</p>
            </div>
        ...
        <div className="border-t border-slate-200 pt-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
              ...
              <ul className="space-y-2 text-slate-700">
                ...
                <li className="flex items-start gap-2">
                  <svg aria-hidden="true" className="w-5 h-5 text-blue-700 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
              ...
              <ul className="space-y-2 text-slate-700">
                <li className="flex items-start gap-2">
                  <svg aria-hidden="true" className="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 0 001.414 0l4-4z" clipRule="evenodd" />
                  </svg>
