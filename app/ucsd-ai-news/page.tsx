        ...
        <div className="max-w-6xl mx-auto px-6 py-20 md:py-24">
          <div className="grid gap-12 lg:grid-cols-[1fr_19rem] lg:items-start">
            <div>
              ...
              <div className="flex flex-col gap-3 border-y border-line py-5 text-sm sm:flex-row sm:flex-wrap sm:items-center sm:gap-x-6">
                <a
                  href="https://tritonai.ucsd.edu/"
                  className="group inline-flex w-fit items-center gap-2 font-semibold text-signal-blue underline decoration-2 underline-offset-4 decoration-[#1f5a8a]/35 transition-colors hover:text-signal-blue hover:decoration-blue-900 focus:outline-none focus:ring-2 focus:ring-signal-blue/30 focus:ring-offset-2"
                >
                ...
                <a
                  ...
                  className="group inline-flex w-fit items-center gap-2 font-semibold text-signal-green underline decoration-2 underline-offset-4 decoration-[#366c5a]/35 transition-colors hover:text-signal-green hover:decoration-emerald-700 focus:outline-none focus:ring-2 focus:ring-signal-green/30 focus:ring-offset-2"
                >
            ...
            <aside className="border-y border-line py-6 lg:mt-3" aria-label="Archive summary">
              <p className="rule-label mb-5">Latest edition</p>
              <div className="font-[family-name:var(--font-display)] text-4xl font-medium leading-tight text-ink">
                {weekLabel}
              </div>
              <div className="mt-6 grid grid-cols-2 gap-x-6 gap-y-5 border-t border-line pt-5">
                <div>
                  <div className="font-mono text-2xl text-ink">{editionCount}</div>
                  <div className="mt-1 text-xs font-semibold uppercase tracking-[0.18em] text-[#5f6a61]">
                    Editions
                  </div>
                </div>
                <div>
                  <div className="font-mono text-2xl text-ink">{itemCount}</div>
                  <div className="mt-1 text-xs font-semibold uppercase tracking-[0.18em] text-[#5f6a61]">
                    Items
                  </div>
                </div>
              </div>
              <p className="mt-6 border-t border-line pt-5 text-sm leading-6 text-[#36423a]">
                {latestStatus}
              </p>
            </aside>
          </div>
              ...
              return (
                ...
                >
                  <div className="px-8 py-6 border-b border-white/10 editorial-dark">
                    <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                      <div>
                        ...
                        <p className="text-wash-blue text-sm mt-1">Source: {edition.sourceFile}</p>
                      </div>
                  ...
                  <div className="px-8 py-7">
                    <div
                      className="max-w-none text-body
                        [&_p]:text-[1.06rem] [&_p]:leading-9 [&_p]:my-5 [&_p]:text-body
                        [&_ul]:my-6 [&_ul]:pl-0
                        [&_ul>li]:list-none [&_ul>li]:pl-5 [&_ul>li]:mb-8
                        [&_ul>li]:border-l-2 [&_ul>li]:border-line
                        [&_ul>li]:text-[1.06rem] [&_ul>li]:leading-9 [&_ul>li]:text-body
