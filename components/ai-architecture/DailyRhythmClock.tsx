 ...
 * live Hermes schedule (48 jobs fire on a typical weekday), not idealized — the three daily
  ...
  return (
    <figure className="w-full my-10" role="img" aria-label="Daily cron rhythm — 24-hour timeline">
      ...
      <p className="mt-5 text-xs text-muted italic max-w-2xl">
        Selected daily and weekday jobs from the live schedule — 48 jobs firing across a
