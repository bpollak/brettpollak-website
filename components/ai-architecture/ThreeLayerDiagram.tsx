...
const REQUEST_TAGS = ['specific memory/', 'dated files', 'raw transcripts', 'full graph JSON · 873 nodes'];
  ...
  return (
    ...
    >
      <figcaption className="sr-only">
        ...
        yesterday) loaded on every session start — about 50 KB. Layer 2 is the 1,076-page
        ...
        files, raw transcripts, the full 873-node graph — loaded only when the human
        explicitly asks.
      </figcaption>
      ...
      <div className="mt-4 md:grid md:grid-cols-[10rem_1fr] md:gap-4 md:items-center">
        <DepthMark n="2" when="On trigger" cost="1,076 pages" color="var(--signal-gold)" inkClass="text-signal-gold-ink" />
        <div
