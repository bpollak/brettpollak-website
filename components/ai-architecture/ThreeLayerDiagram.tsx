      ...
      >
        ...
        <defs>
          ...
          <radialGradient id="l2-grad" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#ff4d1c" stopOpacity="0.16" />
            <stop offset="100%" stopColor="#ff4d1c" stopOpacity="0.08" />
          </radialGradient>
          <radialGradient id="l3-grad" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="#14110f" stopOpacity="0.12" />
            <stop offset="100%" stopColor="#14110f" stopOpacity="0.04" />
          </radialGradient>
        </defs>

        {/* Layer 3 — outer ring */}
        <circle cx="360" cy="260" r="240" fill="url(#l3-grad)" stroke="#14110f" strokeWidth="1.5" strokeDasharray="4 4" />
        <text x="360" y="48" textAnchor="middle" className="fill-muted" style={{ fontSize: '13px', fontWeight: 600, letterSpacing: '0.15em', textTransform: 'uppercase' }}>
          Layer 3 · Explicit Request Only
        </text>

        {/* Layer 2 — middle ring */}
        <circle cx="360" cy="260" r="170" fill="url(#l2-grad)" stroke="#ff4d1c" strokeWidth="2" />
        <text x="360" y="118" textAnchor="middle" className="fill-accent" style={{ fontSize: '13px', fontWeight: 600, letterSpacing: '0.15em', textTransform: 'uppercase' }}>
          Layer 2 · Loaded on Trigger
        </text>

        {/* Layer 1 — center, solid */}
        <circle cx="360" cy="260" r="100" fill="url(#l1-grad)" />
        <text x="360" y="218" textAnchor="middle" className="fill-paper" style={{ fontSize: '11px', fontWeight: 600, letterSpacing: '0.15em', textTransform: 'uppercase' }}>
          Layer 1
        </text>
        <text x="360" y="242" textAnchor="middle" className="fill-paper" style={{ fontSize: '18px', fontWeight: 700 }}>
          Always Loaded
        </text>
        <text x="360" y="265" textAnchor="middle" className="fill-paper" style={{ fontSize: '11px' }}>
          IDENTITY · USER · MEMORY
        </text>
        <text x="360" y="281" textAnchor="middle" className="fill-paper" style={{ fontSize: '11px' }}>
          PATTERNS · today · yesterday
        </text>
        <text x="360" y="303" textAnchor="middle" className="fill-paper" style={{ fontSize: '10px', fontStyle: 'italic' }}>
          ~15 KB · loaded every turn
        </text>

        {/* Layer 2 content labels (arranged around the middle ring) */}
        <text x="230" y="160" className="fill-ink" style={{ fontSize: '11px', fontWeight: 600 }}>
          wiki/people/
        </text>
        <text x="478" y="160" className="fill-ink" style={{ fontSize: '11px', fontWeight: 600 }}>
          wiki/tech-stack/
        </text>
        <text x="198" y="360" className="fill-ink" style={{ fontSize: '11px', fontWeight: 600 }}>
          wiki/decisions/
        </text>
        <text x="478" y="360" className="fill-ink" style={{ fontSize: '11px', fontWeight: 600 }}>
          weekly-synthesis
        </text>
        <text x="360" y="398" textAnchor="middle" className="fill-muted" style={{ fontSize: '10px', fontStyle: 'italic' }}>
          259 pages · pulled in when conversation mentions the topic
        </text>

        {/* Layer 3 content labels */}
        <text x="80" y="254" className="fill-muted" style={{ fontSize: '10px' }}>
          specific memory/
        </text>
        <text x="80" y="270" className="fill-muted" style={{ fontSize: '10px' }}>
          dated files
        </text>
        <text x="570" y="254" className="fill-muted" style={{ fontSize: '10px' }}>
          raw transcripts
        </text>
        <text x="570" y="270" className="fill-muted" style={{ fontSize: '10px' }}>
          full graph JSON
        </text>
        <text x="360" y="490" textAnchor="middle" className="fill-muted" style={{ fontSize: '10px', fontStyle: 'italic' }}>
